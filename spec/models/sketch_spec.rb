...
describe Sketch do
  ...
  it "allows duplicate URLs for different information" do
    s = Sketch.process(url: "http://example.com/png", artist: "John Smith", conference: "Conference 1", topic: "Hello")
    s2 = Sketch.process(url: "http://example.com/png", artist: "John Smith", conference: "Conference 2", topic: "Hello")
